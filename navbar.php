...
<nav>
    <ul>
        <li class="logo"><a class="active" href="./index.php"><img src="img/T_T.jpg" height="20" width="40"></a></li>
        <li class="dropdown"><a href="#" class="dropbtn">Communities</a>
            <div class="dropdown-content">
                <a href="#">Popular</a>
                <a href="#">Top</a>
                <a href="./allCommunities.php">All</a>
                <a href="./community.xml">XML</a>
                <a href="./createCommunity.php">** Create **</a>
            </div>
        </li>
        <li><a href="./profile.html" id="profileTab" style="display:none;">Profile</a></li>
