    ...
    <div class="box">
        <center>
            ...
            <form action="signupAction.php" method=post>
                ...
                <input type="text" name="course" placeholder="Course" style="font-size:20px;"><br><br>
                <input type="text" name="dept" placeholder="Department" style="font-size:20px;"><br><br>
                <input type="text" name="gradYear" placeholder="Graduation Year" style="font-size:20px;"><br><br>
